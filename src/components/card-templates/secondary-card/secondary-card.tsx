...
const Card: FC<CardTemplateProps> = ({ info, onlyFrontSide = false }) => {
  return (
    <div className={cn(commonStyles.flipCard, 'w-full h-full cursor-pointer')}>
      <div className={cn(!onlyFrontSide && commonStyles.flipCardInner)}>
        {!onlyFrontSide && (
          <div className={cn(styles.card, styles.front, commonStyles.flipCardBack)}>
        ...
        <div className={cn(styles.card, styles.back, commonStyles.flipCardFront)}>
          <div className={styles.yellow} />
